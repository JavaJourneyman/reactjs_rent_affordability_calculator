...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
          ...
          exec: {
            ...
            setcors1: 'curl -i -XPOST -H "x-auth-token: AAA0NGX6Ij-f3PV7avw6DKIbbiAMujT5VrNtvM4YkAfSe_L-kwT6teBYJYVSzWcHGDVum33aTska0rMapb-tk0sfHBMka59WmI1AZJfbNBvjo82wEMKctL_iHfkOz5OUyWVQxGEap2NxXA" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.ttf', 
            setcors2: 'curl -i -XPOST -H "x-auth-token: AAA0NGX6Ij-f3PV7avw6DKIbbiAMujT5VrNtvM4YkAfSe_L-kwT6teBYJYVSzWcHGDVum33aTska0rMapb-tk0sfHBMka59WmI1AZJfbNBvjo82wEMKctL_iHfkOz5OUyWVQxGEap2NxXA" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.svg',
            setcors3: 'curl -i -XPOST -H "x-auth-token: AAA0NGX6Ij-f3PV7avw6DKIbbiAMujT5VrNtvM4YkAfSe_L-kwT6teBYJYVSzWcHGDVum33aTska0rMapb-tk0sfHBMka59WmI1AZJfbNBvjo82wEMKctL_iHfkOz5OUyWVQxGEap2NxXA" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.eot',
            setcors4: 'curl -i -XPOST -H "x-auth-token: AAA0NGX6Ij-f3PV7avw6DKIbbiAMujT5VrNtvM4YkAfSe_L-kwT6teBYJYVSzWcHGDVum33aTska0rMapb-tk0sfHBMka59WmI1AZJfbNBvjo82wEMKctL_iHfkOz5OUyWVQxGEap2NxXA" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.woff',
            setcors5: 'curl -i -XPOST -H "x-auth-token: AAA0NGX6Ij-f3PV7avw6DKIbbiAMujT5VrNtvM4YkAfSe_L-kwT6teBYJYVSzWcHGDVum33aTska0rMapb-tk0sfHBMka59WmI1AZJfbNBvjo82wEMKctL_iHfkOz5OUyWVQxGEap2NxXA" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.css'
          },
          watch: {
              scripts: {
                files: '**/*.js',
