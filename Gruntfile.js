...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
          ...
          exec: {
            ...
            setcors1: 'curl -i -XPOST -H "x-auth-token: AADY4LyNfdbBkUG78JfGnjv12aX1S3BnzdyZmLsuZGMGEYKrMnp3P9a5Ao70RZllzFGq7Ztv7REk0JgaHrNK-iOayf9Elo8m6hk8y2f4Qr7YAP2JerIw6E4T0KCynwhmRLk-5_UVcy0kzQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.ttf', 
            setcors2: 'curl -i -XPOST -H "x-auth-token: AADY4LyNfdbBkUG78JfGnjv12aX1S3BnzdyZmLsuZGMGEYKrMnp3P9a5Ao70RZllzFGq7Ztv7REk0JgaHrNK-iOayf9Elo8m6hk8y2f4Qr7YAP2JerIw6E4T0KCynwhmRLk-5_UVcy0kzQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.svg',
            setcors3: 'curl -i -XPOST -H "x-auth-token: AADY4LyNfdbBkUG78JfGnjv12aX1S3BnzdyZmLsuZGMGEYKrMnp3P9a5Ao70RZllzFGq7Ztv7REk0JgaHrNK-iOayf9Elo8m6hk8y2f4Qr7YAP2JerIw6E4T0KCynwhmRLk-5_UVcy0kzQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.eot',
            setcors4: 'curl -i -XPOST -H "x-auth-token: AADY4LyNfdbBkUG78JfGnjv12aX1S3BnzdyZmLsuZGMGEYKrMnp3P9a5Ao70RZllzFGq7Ztv7REk0JgaHrNK-iOayf9Elo8m6hk8y2f4Qr7YAP2JerIw6E4T0KCynwhmRLk-5_UVcy0kzQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.woff',
            setcors5: 'curl -i -XPOST -H "x-auth-token: AADY4LyNfdbBkUG78JfGnjv12aX1S3BnzdyZmLsuZGMGEYKrMnp3P9a5Ao70RZllzFGq7Ztv7REk0JgaHrNK-iOayf9Elo8m6hk8y2f4Qr7YAP2JerIw6E4T0KCynwhmRLk-5_UVcy0kzQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.css'
          },
          watch: {
              scripts: {
                files: '**/*.js',
