...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
          ...
          exec: {
            ...
            setcors1: 'curl -i -XPOST -H "x-auth-token: AABnFVBm_tRiB6fIc7YjxaPo4lOWITRZRIVAojX4oIHOmHSnN0B_WawfWcxbVvO4ZWE_EisoJGSvVdrgswz6DnuUd5RL-IFq17H-BCmDyNlBcVjEI3WeeZ625Iunf79VT3xwXruecDQ79Q" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.ttf', 
            setcors2: 'curl -i -XPOST -H "x-auth-token: AABnFVBm_tRiB6fIc7YjxaPo4lOWITRZRIVAojX4oIHOmHSnN0B_WawfWcxbVvO4ZWE_EisoJGSvVdrgswz6DnuUd5RL-IFq17H-BCmDyNlBcVjEI3WeeZ625Iunf79VT3xwXruecDQ79Q" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.svg',
            setcors3: 'curl -i -XPOST -H "x-auth-token: AABnFVBm_tRiB6fIc7YjxaPo4lOWITRZRIVAojX4oIHOmHSnN0B_WawfWcxbVvO4ZWE_EisoJGSvVdrgswz6DnuUd5RL-IFq17H-BCmDyNlBcVjEI3WeeZ625Iunf79VT3xwXruecDQ79Q" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.eot',
            setcors4: 'curl -i -XPOST -H "x-auth-token: AABnFVBm_tRiB6fIc7YjxaPo4lOWITRZRIVAojX4oIHOmHSnN0B_WawfWcxbVvO4ZWE_EisoJGSvVdrgswz6DnuUd5RL-IFq17H-BCmDyNlBcVjEI3WeeZ625Iunf79VT3xwXruecDQ79Q" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.woff',
            setcors5: 'curl -i -XPOST -H "x-auth-token: AABnFVBm_tRiB6fIc7YjxaPo4lOWITRZRIVAojX4oIHOmHSnN0B_WawfWcxbVvO4ZWE_EisoJGSvVdrgswz6DnuUd5RL-IFq17H-BCmDyNlBcVjEI3WeeZ625Iunf79VT3xwXruecDQ79Q" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.css'
          },
          watch: {
              scripts: {
                files: '**/*.js',
