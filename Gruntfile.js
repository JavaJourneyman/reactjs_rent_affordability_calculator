...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
          ...
          exec: {
            ...
            setcors1: 'curl -i -XPOST -H "x-auth-token: AADysgY655Mg9SR43xzw0IUxd08qXPeOTGwvJK4a6-g0vJDMSzxWIZsMsTPvVXJMoBCB3RPBNpHpzKljwIZI7mAzuNwa63jGlT2mRm2-7l_VPUZockWdhITcsjUSKDIolSQLXtnrsHl8PQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.ttf', 
            setcors2: 'curl -i -XPOST -H "x-auth-token: AADysgY655Mg9SR43xzw0IUxd08qXPeOTGwvJK4a6-g0vJDMSzxWIZsMsTPvVXJMoBCB3RPBNpHpzKljwIZI7mAzuNwa63jGlT2mRm2-7l_VPUZockWdhITcsjUSKDIolSQLXtnrsHl8PQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.svg',
            setcors3: 'curl -i -XPOST -H "x-auth-token: AADysgY655Mg9SR43xzw0IUxd08qXPeOTGwvJK4a6-g0vJDMSzxWIZsMsTPvVXJMoBCB3RPBNpHpzKljwIZI7mAzuNwa63jGlT2mRm2-7l_VPUZockWdhITcsjUSKDIolSQLXtnrsHl8PQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.eot',
            setcors4: 'curl -i -XPOST -H "x-auth-token: AADysgY655Mg9SR43xzw0IUxd08qXPeOTGwvJK4a6-g0vJDMSzxWIZsMsTPvVXJMoBCB3RPBNpHpzKljwIZI7mAzuNwa63jGlT2mRm2-7l_VPUZockWdhITcsjUSKDIolSQLXtnrsHl8PQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.woff',
            setcors5: 'curl -i -XPOST -H "x-auth-token: AADysgY655Mg9SR43xzw0IUxd08qXPeOTGwvJK4a6-g0vJDMSzxWIZsMsTPvVXJMoBCB3RPBNpHpzKljwIZI7mAzuNwa63jGlT2mRm2-7l_VPUZockWdhITcsjUSKDIolSQLXtnrsHl8PQ" -H "Access-Control-Expose-Headers: Access-Control-Allow-Origin" -H "Access-Control-Allow-Origin: *" https://storage101.ord1.clouddrive.com/v1/MossoCloudFS_714ef022-5f5d-4424-ac61-daad9163eaec/rentCalc/rentcalc/build/assets/icons/flaticon.css'
          },
          watch: {
              scripts: {
                files: '**/*.js',
